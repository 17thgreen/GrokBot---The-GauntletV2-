...
**Governor flip (2026-09-11T later):** Logan directs the lab to treat **Polymarket Global** short crypto (5m/15m BTC/ETH Up/Down) as **in-scope for planning** — venue adapters, cockpit, historical contract capture, and eventual capital planning **as if US-usable** — co-primary with **Kalshi**; **Polymarket US** remains watchlist for native US product. Prior inventory facts above (including observed UI messaging that US trade on Global may be blocked `[V]`) are **not** rewritten; the flip is a **Governor planning assumption**, not a counsel determination, filed under `US_LAWFUL_VENUE_CONSTRAINT_2026-09-11.md` §6 and `AMD-20260911-PM-002.md` (**RETROACTIVE: NO**). Not legal advice.
